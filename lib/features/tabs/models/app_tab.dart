...
class AppTab {
  const AppTab({required this.id, this.projectPath, this.path = '', this.validatedPath = ''});
  ...
  AppTab copyWith({String? id, String? projectPath, String? path, String? validatedPath}) {
    return AppTab(
      id: id ?? this.id,
